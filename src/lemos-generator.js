...
module.exports = {
    generate: function(canvasName, topText) {
        ...
        fabric.Image.fromURL('img/lemos.jpg', function (oImg) {
            ...
            var siteText = new fabric.Text('lemurify.com', {
                left: -100,
                top: -100,
                fill: '#fff',
                fontFamily: 'sans-serif',
